...
extension NewPostViewController {
   ...
   fileprivate func save() {
      ...
      let portrait = image.size.width < image.size.height
      let newPost = PostModel(uid: currentUser.userId, author: currentUser.name, title: title, body: bodyText, portrait: portrait)
